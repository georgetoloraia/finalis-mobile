...
fun NetworkMismatchSection(
    ...
    WalletPanel(
        ...
        LabelValue(label = "Endpoint network id", value = status.networkId ?: "(not provided)", monospace = true)
        LabelValue(label = "Endpoint genesis", value = status.genesisHash ?: "(not provided)", monospace = true)
        SectionDivider()
